    ...
    <View style={styles.container}>
      <View style={styles.dropDown}>
        <View style={styles.innerView}>
          ...
          <Text style={{ fontSize: 18, fontWeight: 'bold' }}>{item.billDate}</Text>
        </View>

        <TouchableOpacity onPress={() => openPDF(item.billURL)}>
      ...
      {!isCollapsed && (
        <View style={styles.collapsibleContainer}>
          ...
          <View style={styles.innerCollapsibleContainer}>
            ...
            <Text style={styles.text}>{item.billNumber}</Text>
          </View>
        </View>
      )}
    </View>
...
export default CustomBillsList
